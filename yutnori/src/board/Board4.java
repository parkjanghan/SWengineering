...
// 25번 노드
        ...
        boardShape.get(25).addNext_nodes(YutResult.MO, new ArrayList<>(List.of(30))); // 모
...
// 26번 노드
        ...
        boardShape.get(26).addNext_nodes(YutResult.MO, new ArrayList<>(List.of(18))); // 모
        ...
        boardShape.get(27).addNext_nodes(YutResult.GAE, new ArrayList<>(List.of(30))); // 개
...
// 28번 노드
        ...
        boardShape.get(28).addNext_nodes(YutResult.DO, new ArrayList<>(List.of(30))); // 도
...
// 29번 노드
        ...
        boardShape.get(29).addNext_nodes(YutResult.GEOL, new ArrayList<>(List.of(30))); // 걸
